...
GeoIP.prototype.load = function(filename)
{
	if (filename === undefined)
		filename = './core/lib/geo/GeoIP.dat';
		
	try 
	{
		this.buffer = fs.readFileSync(filename, "binary");
		
		sys.puts(filename + " loaded (length = " + this.buffer.length + ")");
	}
	catch (e) {
		sys.puts("GeoIP error: " + e);
	}
